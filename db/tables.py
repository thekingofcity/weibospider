...
wbuser = Table("wbuser", metadata,
               ...
               Column("location_extend", String(45), default='', server_default=''),
               ...
               Column("crawl_time", DateTime, default=func.now(), onupdate=func.now()),
               )
...
weibo_data = Table('weibo_data', metadata,
                   ...
                   Column("origin_weibo_id", String(200), unique=True, server_default=''),
